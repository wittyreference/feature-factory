...
6. **Auto-memory** — User's project-specific auto-memory file
...
- If the topic is broad (e.g., "auth", "database"), limit to 3 matches per source to avoid overwhelming output
