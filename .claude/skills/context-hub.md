---
name: context-hub
description: External API documentation fetcher. Use when writing code that calls external APIs (Stripe, OpenAI, etc.) to get curated docs and prevent hallucinated API shapes.
---
