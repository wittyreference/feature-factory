...
| Credential safety | No hardcoded secrets (API keys, tokens, passwords) |
...
**Pre-approved:**
- Configured test, lint, and build commands
...
| Task | What it does |
|------|-------------|
| `validate` | Run /preflight, then configured test command with --bail |
