...
| Tool/CLI boundaries | .claude/references/tool-boundaries.md |
...
1. Search official docs for the relevant technology
...
```markdown
- Max payload 10MB <!-- verified: docs.example.com/limits -->
